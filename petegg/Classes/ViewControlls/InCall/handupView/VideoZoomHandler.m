...
- (void)zoomInOut:(UITapGestureRecognizer*) reco {
    ...
    sephone_call_zoom_video(sephone_core_get_current_call([SephoneManager getLc]), zoomLevel, &cx, &cy);
}
...
- (void)videoPan:(UIPanGestureRecognizer*) reco {
    ...
    sephone_call_zoom_video(sephone_core_get_current_call([SephoneManager getLc]), zoomLevel, &x, &y);
    cx = x;
    cy = y;
}
...
- (void)pinch:(UIPinchGestureRecognizer*) reco {
    ...
    sephone_call_zoom_video(sephone_core_get_current_call([SephoneManager getLc]), s, &cx, &cy);
}
