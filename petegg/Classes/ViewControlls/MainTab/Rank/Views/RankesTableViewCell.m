...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        _nameLabel = [[UILabel alloc]initWithFrame:CGRectMake(110 * W_Wide_Zoom, 20 * W_Hight_Zoom, 100 * W_Wide_Zoom, 20 * W_Hight_Zoom)];
        ...
        _rightImage = [[UIImageView alloc]initWithFrame:CGRectMake(110 * W_Wide_Zoom, 40 * W_Hight_Zoom, 12 * W_Wide_Zoom, 12 * W_Hight_Zoom)];
        _rightImage.image = [UIImage imageNamed:@"dianzanhou.png"];
        [self addSubview:_rightImage];
        
        _aixinLabel = [[UILabel alloc]initWithFrame:CGRectMake(128 * W_Wide_Zoom, 36 * W_Hight_Zoom , 100 * W_Wide_Zoom, 20 * W_Hight_Zoom)];
